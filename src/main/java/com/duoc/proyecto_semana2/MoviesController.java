...
public class MoviesController {
    ...
    public MoviesController() {
        ...
        movies.add(new Movie(6, "Buscando a Nemo", 2003, "Andrew Stanton", "Animación", "Un pez payaso cruza el océano para encontrar a su hijo perdido."));
        movies.add(new Movie(7, "Bichos", 1998, "John Lasseter", "Animación", "Una hormiga busca ayuda para salvar a su colonia de unos saltamontes."));
    }
